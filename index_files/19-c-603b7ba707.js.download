(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[19],{"1sWr":function(e,t,n){e.exports=n.p+"ef94dfdfb8ea4d6ee98c7b1b2f4cfa32.svg"},"8o96":function(e,t,n){"use strict"
...
var S=n("oXx0")
var j=n("jtGx")
function B(e){var t=e.colors,n=e.borders,r=e.spacing,o=e.typography,a=e.forms
...
var k=(H=Object(S["a"])(),C=Object(O["j"])(B,z),H(M=C(M=(q=F=function(e){Object(i["a"])(n,e)
var t=Object(l["a"])(n)
function n(){var e
Object(o["a"])(this,n)
e=t.call(this)
...
var o=Object(x["a"])(e.props.maxHeight,e._container)
...
else if(Object(x["a"])(e.props.height,e._container)>e._textarea.scrollHeight){e._textarea.style.overflowY="auto"
r=e.props.height}var a=Object(x["a"])(r)>o
...
var o=this.props,a=o.autoGrow,i=o.placeholder,l=o.value,c=o.defaultValue,d=o.disabled,u=o.readOnly,h=o.required,m=o.width,f=o.height,g=o.maxHeight,v=o.textareaRef,y=o.resize,w=o.size
var _=Object(j["a"])(this.props,n.propTypes)
var x=(e={},Object(r["a"])(e,z.textarea,true),Object(r["a"])(e,z[w],true),Object(r["a"])(e,z.disabled,d),e)
var O={width:m,resize:y,height:a?null:f,maxHeight:g}
var S=s.a.createElement("textarea",Object.assign({},_,{value:l,defaultValue:c,placeholder:i,ref:function(e){t._textarea=e
for(var n=arguments.length,r=new Array(n>1?n-1:0),o=1;o<n;o++)r[o-1]=arguments[o]
v.apply(t,[e].concat(r))},style:O,id:this.id,required:h,"aria-required":h,"aria-invalid":this.invalid?"true":null,disabled:d||u,className:b()(x),onChange:this.handleChange}))
return s.a.createElement(p["a"],Object.assign({},Object(j["c"])(this.props,p["a"].propTypes),{vAlign:"top",id:this.id,ref:function(e){t._node=e}}),s.a.createElement("div",{className:z.layout,style:{width:m,maxHeight:g},ref:this.handleContainerRef},S,d||u?null:s.a.createElement("span",{className:z.outline,"aria-hidden":"true"})))}},{key:"minHeight",get:function(){return this._textarea.style.minHeight}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"id",get:function(){return this.props.id||this._defaultId}},{key:"focused",get:function(){return Object(y["a"])(this._textarea)}},{key:"value",get:function(){return this._textarea.value}}])
n.displayName="TextArea"
return n}(c["Component"]),F.propTypes={label:u.a.node.isRequired,id:u.a.string,size:u.a.oneOf(["small","medium","large"]),layout:u.a.oneOf(["stacked","inline"]),autoGrow:u.a.bool,resize:u.a.oneOf(["none","both","horizontal","vertical"]),width:u.a.string,height:u.a.string,maxHeight:u.a.oneOfType([u.a.number,u.a.string]),messages:u.a.arrayOf(p["d"].message),inline:u.a.bool,placeholder:u.a.string,disabled:u.a.bool,readOnly:u.a.bool,required:u.a.bool,textareaRef:u.a.func,defaultValue:u.a.string,value:Object(m["a"])(u.a.string),onChange:u.a.func},F.defaultProps={size:"medium",autoGrow:true,resize:"none",inline:false,messages:[],disabled:false,readOnly:false,textareaRef:function(e){},layout:"stacked",id:void 0,value:void 0,defaultValue:void 0,onChange:void 0,required:false,placeholder:void 0,width:void 0,height:void 0,maxHeight:void 0},q))||M)||M)},UUaj:function(e,t,n){"use strict"
var r=n("HGxv")
t["a"]=r["default"].scoped("assignments_2")},WEeK:function(e,t,n){"use strict"
...
var t=this.props,n=t.type,a=t.size,i=t.htmlSize,l=(t.display,t.textAlign),c=t.placeholder,s=t.value,u=t.defaultValue,h=t.required,b=t.isRequired,p=Object(o["a"])(t,["type","size","htmlSize","display","textAlign","placeholder","value","defaultValue","required","isRequired"])
var f=Object(g["b"])(p)
var v=this.interaction
var y=(e={},Object(r["a"])(e,q.input,true),Object(r["a"])(e,q[a],a),Object(r["a"])(e,q["textAlign--".concat(l)],l),e)
var w=""
f["aria-describedby"]&&(w="".concat(f["aria-describedby"]))
this.hasMessages&&(w=""!==w?"".concat(w," ").concat(this._messagesId):this._messagesId)
return d.a.createElement("input",Object.assign({},f,{className:m()(y),defaultValue:u,value:s,placeholder:c,ref:this.handleInputRef,type:n,id:this.id,required:b||h,"aria-invalid":this.invalid?"true":null,disabled:"disabled"===v,readOnly:"readonly"===v,"aria-describedby":""!==w?w:null,size:i,onChange:this.handleChange,onBlur:this.handleBlur,onFocus:this.handleFocus}))}},{key:"render",value:function(){var e
var t=this.props,n=t.width,o=t.inline,a=t.display,i=t.label,l=t.renderLabel,c=t.renderBeforeInput,s=t.renderAfterInput,u=t.messages,h=t.inputContainerRef,b=t.icon,p=t.shouldNotWrap
var f=this.interaction
var g=c||s||b
var y=(e={},Object(r["a"])(e,q.facade,true),Object(r["a"])(e,q.disabled,"disabled"===f),Object(r["a"])(e,q.invalid,this.invalid),Object(r["a"])(e,q.focused,this.state.hasFocus),e)
return d.a.createElement(_["a"],{id:this.id,label:Object(v["a"])(l||i),messagesId:this._messagesId,messages:u,inline:"inline-block"===a||o,width:n,inputContainerRef:h,layout:this.props.layout},d.a.createElement("span",{className:m()(y)},g?d.a.createElement(x["a"],{wrap:p?"no-wrap":"wrap"},c&&d.a.createElement(x["a"].Item,{padding:"0 0 0 small"},Object(v["a"])(c)),d.a.createElement(x["a"].Item,{shouldGrow:true,shouldShrink:true},d.a.createElement(x["a"],null,d.a.createElement(x["a"].Item,{shouldGrow:true,shouldShrink:true},this.renderInput()),(s||b)&&d.a.createElement(x["a"].Item,{padding:"0 small 0 0"},s?Object(v["a"])(s):Object(v["a"])(b))))):this.renderInput()))}},{key:"interaction",get:function(){return Object(y["a"])({props:this.props})}},{key:"hasMessages",get:function(){return this.props.messages&&this.props.messages.length>0}},{key:"invalid",get:function(){return this.props.messages&&this.props.messages.findIndex((function(e){return"error"===e.type}))>=0}},{key:"focused",get:function(){return Object(w["a"])(this._input)}},{key:"value",get:function(){return this._input.value}},{key:"id",get:function(){return this.props.id||this._defaultId}}])
n.displayName="TextInput"
return n}(s["Component"]),M.propTypes={renderLabel:h.a.oneOfType([h.a.node,h.a.func]),type:h.a.oneOf(["text","email","url","tel","search","password"]),id:h.a.string,value:Object(p["a"])(h.a.string),defaultValue:h.a.string,interaction:h.a.oneOf(["enabled","disabled","readonly"]),messages:h.a.arrayOf(_["d"].message),size:h.a.oneOf(["small","medium","large"]),textAlign:h.a.oneOf(["start","center"]),width:h.a.string,htmlSize:h.a.oneOfType([h.a.string,h.a.number]),display:h.a.oneOf(["inline-block","block"]),shouldNotWrap:h.a.bool,placeholder:h.a.string,isRequired:h.a.bool,inputRef:h.a.func,inputContainerRef:h.a.func,renderBeforeInput:h.a.oneOfType([h.a.node,h.a.func]),renderAfterInput:h.a.oneOfType([h.a.node,h.a.func]),onChange:h.a.func,onBlur:h.a.func,onFocus:h.a.func,icon:h.a.func,label:h.a.oneOfType([h.a.node,h.a.func]),required:h.a.bool,inline:h.a.bool},M.defaultProps={renderLabel:void 0,type:"text",id:void 0,interaction:void 0,isRequired:false,value:void 0,defaultValue:void 0,display:"block",shouldNotWrap:false,placeholder:void 0,width:void 0,size:"medium",htmlSize:void 0,textAlign:"start",messages:[],inputRef:function(e){},inputContainerRef:function(e){},onChange:function(e,t){},onBlur:function(e){},onFocus:function(e){},renderBeforeInput:void 0,renderAfterInput:void 0},F))||C)||C)},cClk:function(e,t,n){"use strict"
...
if(i)return i
if(r[o]&&"function"!==typeof r[t])return new Error(["You provided a '".concat(o,"' prop without an '").concat(t,"' handler on '").concat(a,"'. This will render a controlled component. If the component should be uncontrolled and manage its own state, use '").concat(n,"'. Otherwise, set '").concat(t,"'.")].join(""))}}},eGSd:function(e,t,n){"use strict"
n.d(t,"a",(function(){return r}))
...
var b=u?Math.max(+n.maxWait||0,t):0
function m(t){var n=r
var i=o
r=o=void 0
l=t
if(true!==s){a=e.apply(i,n)
return a}}function p(e){l=e
c.push(setTimeout(v,t))
return d?m(e):a}function f(e){var n=e-i
var r=e-l
var o=t-n
return u?Math.min(o,b-r):o}function g(e){var n=e-i
var r=e-l
return"undefined"===typeof i||n>=t||n<0||u&&r>=b}function v(){var e=Date.now()
if(g(e))return y(e)
c.push(setTimeout(v,f(e)))}function y(e){x()
if(h&&r)return m(e)
r=o=void 0
return a}function w(){s=true
x()
l=0
r=i=o=void 0}function _(){return 0===c.length?a:y(Date.now())}function x(){c.forEach((function(e){return clearTimeout(e)}))
...
o=this
i=e
if(n){if(0===c.length)return p(i)
if(u){c.push(setTimeout(v,t))
return m(i)}}0===c.length&&c.push(setTimeout(v,t))
return a}O.cancel=w
O.flush=_
return O}},gCYW:function(e,t,n){"use strict"
...
t.bottom+=b.top
t.left+=b.left
t.right+=b.left}}return{top:t.top+(window.pageYOffset||s.scrollTop)-(s.clientTop||0),left:t.left+(window.pageXOffset||s.scrollLeft)-(s.clientLeft||0),width:(null==t.width?n.offsetWidth:t.width)||0,height:(null==t.height?n.offsetHeight:t.height)||0,right:c.body.clientWidth-t.width-t.left,bottom:c.body.clientHeight-t.height-t.top}}},msMH:function(e,t,n){"use strict"
n.d(t,"a",(function(){return z}))
var r=n("rePB")
var o=n("Ff2n")
var a=n("1OyB")
...
return Object(r["a"])(s["a"],{margin:"small"},void 0,Object(r["a"])(b["a"],{onChange:e.handleChangeCommentBox,label:a.t("What happened?"),value:e.textAreaComment}),Object(r["a"])(s["a"],{margin:"small"},void 0,Object(r["a"])(m["a"],{onChange:e.handleChangeEmail,renderLabel:a.t("Your Email Address"),isRequired:true,placeholder:a.t("email@example.com"),value:e.email})),Object(r["a"])(s["a"],{textAlign:"end",display:"block"},void 0,Object(r["a"])(c["a"],{margin:"small 0",color:"primary",interaction:t,onClick:e.handleSubmitErrorReport},void 0,a.t("Submit"))))}var f=n("UUaj")
var g=n("msMH")
function v(e){return Object(r["a"])(s["a"],{display:"block"},void 0,Object(r["a"])(g["a"],{level:"h1"},void 0,f["a"].t("Sorry, Something Broke")),Object(r["a"])(s["a"],{maxWidth:"16rem",margin:"large auto",display:"block","aria-hidden":true},void 0,Object(r["a"])("img",{alt:"",src:e.imageUrl})))}class y extends l.a.Component{constructor(...e){super(...e)
...
this.handleSubmitErrorReport=async()=>{const e={error:{subject:this.props.errorSubject,category:this.props.errorCategory,url:window.location.href,comments:this.state.textAreaComment,email:this.state.email}}
this.setState({submitLoading:true,showingCommentBox:false})
try{const t=await h["a"].post("/error_reports",e,{headers:{"content-type":"application/json"}})
const n=t.data
n.logged?this.setState({commentPosted:true,submitLoading:false}):this.setState({commentPosted:true,commentPostError:true,submitLoading:false})}catch(e){this.setState({commentPosted:true,commentPostError:true,submitLoading:false})}}}render(){return Object(r["a"])(s["a"],{as:"div",width:"100%",height:"100%",margin:"large auto",textAlign:"center",display:"block"},void 0,Object(r["a"])(v,{imageUrl:this.props.imageUrl}),Object(r["a"])(s["a"],{margin:"small",display:"block"},void 0,!this.state.commentPosted&&l.a.createElement(l.a.Fragment,null,Object(r["a"])(s["a"],{margin:"small",display:"block"},void 0,Object(r["a"])(d["a"],{margin:"0"},void 0,a.t("Help us improve by telling us what happened"))),Object(r["a"])(s["a"],{margin:"small",display:"block"},void 0,Object(r["a"])(c["a"],{margin:"0",color:"primary",onClick:this.handleOpenCommentBox},void 0,a.t("Report Issue")))),this.state.showingCommentBox&&Object(r["a"])(p,{textAreaComment:this.state.textAreaComment,email:this.state.email,handleChangeCommentBox:this.handleChangeCommentBox,handleChangeEmail:this.handleChangeEmail,handleSubmitErrorReport:this.handleSubmitErrorReport}),this.state.submitLoading&&Object(r["a"])(u["a"],{renderTitle:a.t("Loading"),margin:"0 0 0 medium"}),this.state.commentPosted&&this.state.commentPostError&&Object(r["a"])(s["a"],{display:"block","data-test-id":"generic-error-comments-submitted"},void 0,Object(r["a"])(d["a"],{color:"danger",margin:"x-small"},void 0,a.t("Comment failed to post! Please try again later."))),this.state.commentPosted&&!this.state.commentPostError&&Object(r["a"])(s["a"],{display:"block","data-test-id":"generic-error-comments-submitted"},void 0,Object(r["a"])(d["a"],{margin:"x-small"},void 0,a.t("Comment submitted!")))))}}y.defaultProps={errorSubject:"No Error Subject",errorCategory:"No Error Category"}}}])

//# sourceMappingURL=19-c-603b7ba707.js.map